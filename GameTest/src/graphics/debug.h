...
namespace gfx
{
	...
	struct Debug
	{
		...
		static void DrawCircle(const math::IVec2& origin, float radius, const Color& color = draw_color);
		static void DrawCircle(const math::IVec2& origin, float radius, const Color& color = draw_color, unsigned int steps = circle_steps);
